    ...
    return (
        (content) ?
            <div class="bg-[#012E66] flex-wrap flex w-full py-[15px] my-[20px]">
                ...
                <div class=" container grid grid-cols-[repeat(5,_1fr)] grid-rows-[1fr] gap-x-[0px] gap-y-[0px] w-full">
                {content.map((item) => (
                    <div class="flex items-center align-middle mx-auto ">
                        <p class="bg-transparent text-transparent content-text-edit text-[80px] mr-[5px]">{item?.number}</p>
