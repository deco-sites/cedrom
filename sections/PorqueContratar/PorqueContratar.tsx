...
export default function PorqueContratar( {
    ...
    itens = [
        ...
        {
            text: 'Segurança que os serviços e obras não serão interrompidos por falta de caixa'
        },
        {
            text: 'Fluxo de caixa previsível para planejar obras e melhorias'
        },
        {
            text: 'Taxa de condomínio estável e previsível: não haverá aumento para cobrir a inadimplência'
        },
        {
